...
namespace Saydalia_Online.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<Saydalia_Online_AuthUser> _userStore;
        ...
        private Saydalia_Online_AuthUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<Saydalia_Online_AuthUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Saydalia_Online_AuthUser)}'. " +
                    $"Ensure that '{nameof(Saydalia_Online_AuthUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<Saydalia_Online_AuthUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<Saydalia_Online_AuthUser>)_userStore;
        }
    }
}
